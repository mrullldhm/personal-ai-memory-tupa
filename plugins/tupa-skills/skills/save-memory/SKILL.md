...
# Save Memory
*Persist conversation insights and preferences to Tupa's memory files*
...
- [ ] Update `main/relationship-memory.md` with new preferences or learned patterns
- [ ] Update `main/current-session.md` with current working context
- [ ] Add diary entry if a significant conversation occurred
